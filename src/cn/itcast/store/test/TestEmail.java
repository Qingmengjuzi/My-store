	...
	public static void main(String[] args) throws Exception {
		...
		Authenticator authenticator = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				//设置发送者的邮箱账号和密码
				return new PasswordAuthentication("admin@why.com", "admin");
			}
		};
		...
		message.setFrom(new InternetAddress("admin@why.com"));
		// 2.2 收件人 , to:收件人 ， cc ：抄送，bcc：暗送（密送）。（模拟账号）
		message.setRecipient(RecipientType.TO, new InternetAddress("aaa@why.com"));
		// 2.3 主题
